...
FFMPEG_FLAG_MAP=(
		...
		X:xlib X:libxcb X:libxcb-shm X:libxcb-xfixes +zlib rkmpp
		# libavdevice options
...
RDEPEND="
	...
	rkmpp? ( media-libs/librga media-libs/libyuv media-libs/rockchip-mpp )
"
...
PATCHES=(
	...
	"${FILESDIR}"/add-av_stream_get_first_dts-for-chromium.patch
	"${FILESDIR}"/rkmpp-6.patch
)
...
multilib_src_configure() {
	...
	use rkmpp && myconf+=( --enable-version3 )
