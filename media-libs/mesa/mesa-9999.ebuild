...
inherit llvm meson-multilib python-any-r1 linux-info git-r3

MY_P="${P/_/-}"

DESCRIPTION="panfork mesa to support mali g610"
HOMEPAGE="https://gitlab.com/panfork/mesa/"
EGIT_REPO_URI="https://gitlab.com/panfork/mesa.git"
EGIT_BRANCH="csf"
EGIT_COMMIT="120202c675749c5ef81ae4c8cdc30019b4de08f4"
LICENSE="MIT"
SLOT="0"
RESTRICT="!test? ( test )"
PATCHES=(
